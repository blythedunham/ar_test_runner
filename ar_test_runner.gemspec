...
Gem::Specification.new do |s|
  ...
  s.files = ["bin/ar_test_runner", "gem_install.rb", "init.rb", "lib/ar_test_runner.rb", "lib/ar_test_runner_includes.rb", "MIT-LICENSE", "Rakefile", "README.rdoc", "tasks/ar_test_runner_tasks.rake", "uninstall.rb", "Manifest", "ar_test_runner.gemspec"]
  s.has_rdoc = true
